#
#  Be sure to run `pod spec lint VIAnalyticsKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/Vienta/VIAnalyticsKit"
  ...
  # s.social_media_url   = "http://www.vienta.me"
  ...
  s.source       = { :git => "https://github.com/Vienta/VIAnalyticsKit.git", :tag => "0.0.2" }
  ...
  s.source_files  = "VIAnalyticsKit/Class/*.{h,m}"
